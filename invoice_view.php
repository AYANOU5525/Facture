<?php
require_once 'auth.php'; // Pour vérifier la connexion
require_once 'db.php';
...
// On récupère aussi les infos de NOTRE entreprise (Vendeur)
$stmt = $pdo->prepare("
    ...
    WHERE v.Id_Vente = ? AND v.Id_Entreprise = ?
");
$stmt->execute([$id_vente, $my_entreprise_id]);
$vente = $stmt->fetch();
