        ...
        <nav class="navbar">
            <div class="container navbar-content">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="invoices.php" class="<?= basename($_SERVER['PHP_SELF']) == 'invoices.php' ? 'active' : '' ?>"><i class="fas fa-file-invoice"></i> Factures</a></li>
                    <li><a href="logistique.php" class="<?= basename($_SERVER['PHP_SELF']) == 'logistique.php' ? 'active' : '' ?>"><i class="fas fa-truck"></i> Logistique</a></li>
                    ...
                    <li class="logout-link"><a href="../includes/logout.php"><i class="fas fa-sign-out-alt"></i></a></li>
                </ul>
            </div>
        </nav>
        <style>
